...
class FavoriteProducts {
    ...
    static let CHOCOLATE_MUFFIN = ProductItem(name: "Chocolate Muffin", type: -1, des: "Chocolatly fresh baked", imageUrl: "sample-muffin", price: 4.30, rating: 4)
    static let CLASSIC_BAGEL = ProductItem(name: "Classic Bagel", type: -1, des: "Classic and fresh", imageUrl: "sample-bagel", price: 2.0, rating: 4)
    static let CARAMEL_FRAPPE: ProductItem = ProductItem(name: "Caramel Frappe", type: 1, des: "Decaf Colombia", imageUrl: "sample-favorite-caramel", price: 10.0, rating: 0)
    ...
    static let CHOCO_COOKIES: ProductItem = ProductItem(name: "Choco Cookies", type: 1, des: "Freshly baked", imageUrl: "sample-choco-cookies", price: 10.0, rating: 0)
    static let CHOCO_FRAPPE: ProductItem = ProductItem(name: "Choco Frappe", type: 1, des: "Locally Roasted", imageUrl: "sample-favorite-choco", price: 10.0, rating: 0)
