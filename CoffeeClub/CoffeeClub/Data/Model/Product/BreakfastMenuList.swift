...
class BreakfastMenuList {
    ...
    static let CHICKEN_VIGGIE_PIE: ProductItem = ProductItem(name: "Chicken & Viggie Pie", type: -1, des: "Made with tender 100% chicken and baked fresh in store everyday", detail: "", imageUrl: "sample-pie", price: 6.50, rating: 0)
    static let CHOCO_COOKIES: ProductItem = ProductItem(name: "Choco Cookies", type: -1, des: "Freshly baked choco chips cookies", detail: "", imageUrl: "sample-cookies", price: 2.25, rating: 0)
    static let STRAWBERRY_PANCAKES: ProductItem = ProductItem(name: "Strawberry Pancakes", type: -1, des: "Light and fluffy pancakes packed", detail: "", imageUrl: "sample-pancake", price: 4.00, rating: 0)
